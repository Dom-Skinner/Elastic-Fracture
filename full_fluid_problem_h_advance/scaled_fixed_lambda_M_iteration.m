function [KI, hprime_new,p] = scaled_fixed_lambda_M_iteration(x,z,v,w,t,xmax, lambda, tol, hprime_start)
...
K22 = shear_matrix_h(x,w-2.2,t,lambda);

kernel_matrix = [K11,K12 ; K21,K22];
