...
for i=1:length(lambda)
    ...
    [KI(i),hprime_new,p] = scaled_fixed_lambda_M_iteration(n,xmax,lambda(i),tol,hprime_start);
...
while 1
    ...
    [KI(i),hprime_new] = scaled_fixed_lambda_M_iteration(n,xmax,lambda(i),tol,hprime_start);
