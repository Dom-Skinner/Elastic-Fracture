...
function [p, dp] = scaled_hprime_to_p_sansg(x,z,hprime,lambda, h_coefficient_matrix)
...
h_coeffs = h_coefficient_matrix*hprime(1:n);
...
dp(1:n-1,1:n) = lambda*deriv_pressure;
