function [K11aint, K11bint, K11eint, K11gint, K11iint, ...
    K12cint, K12dint, K12fint, K12hint, K12jint, ...
    K21aint, K21bint, K21eint, K21gint, K21iint, ...
    K22cint, K22dint, K22fint, K22hint, K22jint] = quadinvandinvsquarekernelmatrices(x,z)
...
K11iint = real(8.*x.^(-1).*(4+z.^2).^(-3).*((-4)+3.*z.^2)+(-8).*(4+z.^2).^(-2).*( ...
...
...
K12jint = real((1/4).*(64.*(4+2.*x.*z+(-3).*z.^2).*(4+z.^2).^(-2).*(4+x.^2+(-2).* ...
...
...
K21iint = -real((1/4).*((-64).*(4+2.*x.*z+(-3).*z.^2).*(4+z.^2).^(-2).*(4+x.^2+( ...
 ...
...
K22jint = -real(8.*x.^(-1).*(4+z.^2).^(-3).*((-4)+3.*z.^2)+(-8).*(4+z.^2).^(-2).*( ...
...
  4+x.^2+(-2).*x.*z+z.^2).^(-2).*(4.*x+(-12).*z+(-1).*x.*z.^2+z.^3)+ ...
...
  8.*(4+z.^2).^(-3).*(4+x.^2+(-2).*x.*z+z.^2).^(-1).*(28.*z+(-9).* ...
