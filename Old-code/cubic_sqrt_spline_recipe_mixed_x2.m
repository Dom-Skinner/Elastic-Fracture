function mixcoeffs = cubic_sqrt_spline_recipe_mixed_x2(x, y, y1ddash, ynddash)
...
d_pure_1 = [2*x_join, 1, 0, -x_join^(-2)]*pure_coeffs_1(1:4)';
d_pure_2 = [2*x_join, 1, 0, -x_join^(-2)]*pure_coeffs_2(1:4)';

dd_pure_actual_1 = [2, 0, 0, 2*x_join^(-3)]*pure_coeffs_1(1:4)';
dd_pure_actual_2 = [2, 0, 0, 2*x_join^(-3)]*pure_coeffs_2(1:4)';
