...
for i = 1:length(n)
    ...
    [KI, KII, soln, gprime, hprime, inpoint, interpol] = nofluidsolution3(n(i), endpoint, 0,1,0);
...
axis([0, 0.25, -2*10^(-3), 2*10^(-3)]);
hold off;

print -depsc '../latex/plots/pressure_error_test/Msoln_tip_picture_pressure.eps'
...
legend('n=100','n=140','n=200','n=280','n=400');
axis([0, 0.25, -10^(-3), 10^(-3)]);
hold off;

print -depsc '../latex/plots/pressure_error_test/Msoln_tip_picture_shear.eps'
...
print -depsc '../latex/plots/pressure_error_test/Msoln_ffield_picture_pressure.eps'
...
print -depsc '../latex/plots/pressure_error_test/Msoln_ffield_picture_shear.eps'
...
print -depsc '../latex/plots/pressure_error_test/Msoln_tip_max_pressure.eps'
...
print -depsc '../latex/plots/pressure_error_test/Msoln_tip_max_shear.eps'
...
print -depsc '../latex/plots/pressure_error_test/Msoln_ffield_max_pressure.eps'
...
print -depsc '../latex/plots/pressure_error_test/Msoln_ffield_max_shear.eps'
