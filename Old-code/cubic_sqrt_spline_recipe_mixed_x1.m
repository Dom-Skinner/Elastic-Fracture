...
d_pure_1 = [1, 0, -x_join^(-2), -2*x_join^(-3)]*pure_coeffs_1(1:4)';
d_pure_2 = [1, 0, -x_join^(-2), -2*x_join^(-3)]*pure_coeffs_2(1:4)';

dd_pure_actual_1 = [0, 0, 2*x_join^(-3), 6*x_join^(-4)]*pure_coeffs_1(1:4)';
dd_pure_actual_2 = [0, 0, 2*x_join^(-3), 6*x_join^(-4)]*pure_coeffs_2(1:4)';

A_dd_pure = (dd_pure_actual_2-dd_pure_actual_1)/(dd_pure_2-dd_pure_1);
B_dd_pure = (dd_pure_2*dd_pure_actual_1 - dd_pure_1*dd_pure_actual_2)...
    /(dd_pure_2 - dd_pure_1);
