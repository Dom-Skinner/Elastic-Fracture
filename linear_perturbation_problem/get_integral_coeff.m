function [w_coeff, e_coeff, r_coeff] = get_integral_coeff(x1,x2,H1,H2,alpha,beta,l0)
...
w_coeff = 2*l0*(c1*w_co1 + c2*w_co2);
e_coeff = 2*l0*(c1*e_co1 + c2*e_co2);
r_coeff = 2*l0*(c1*r_co1 + c2*r_co2);
